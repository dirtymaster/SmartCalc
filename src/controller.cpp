...
bool Controller::Calculate(const char* input_expression,
                           const char* input_expression_x) {
    bool return_value =
        model_->MainFunction(input_expression, input_expression_x);
    if (return_value) {
...
bool Controller::Calculate(const char* input_expression,
                           long double x) {
    bool return_value =
        model_->MainFunction(input_expression, x);
    if (return_value) {
        result_ = model_->GetResult();
    }
    return return_value;
...
bool Controller::CheckGraphicParameters(
    ...
    return model_->CheckGraphicParameters(
